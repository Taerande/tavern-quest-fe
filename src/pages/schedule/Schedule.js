...
const Schedule = () => {
    ...
    useEffect(() => {
        getScheduleData(params.scheduleId).then(async (res) => {
            ...
            if (auth) {
                if (res.scheduleInfo.characters[0].user_id === auth.uid) {
                    ...
                    setLeaderInfo(res.scheduleInfo.characters[0]);
                    setIsLoading(false);
                    setScheduleData(res);
    ...
    }, [params.scheduleId, auth, dispatch,navigate])
    return (
        <div className={ styles.container}>
            ...
            {!isLoading && scheduleData && <>
                ...
                <ScheduleHeader leaderInfo={leaderInfo} scheduleInfo={scheduleData.scheduleInfo} />
                <Divider style={{padding:'20px'}} />
